...
load_default_config() {
    ...
    # API配置（必需）
    # -----------------------------------------------------------------------------
    export DF_API_KEY="${DF_API_KEY:-dummy_key}"                    # API密钥
    export DF_API_URL="${DF_API_URL:-http://localhost:12345/v1/chat/completions}"                    # API地址
    ...
    export LOCAL_MODEL_NAME_OR_PATH="${LOCAL_MODEL_NAME_OR_PATH:-/mnt/public/model/huggingface/Qwen3-30B-A3B-Instruct-2507}"  # 本地模型路径
    ...
    export SERVER_PORT="${SERVER_PORT:-8001}"                              # 服务器端口
    ...
    export DEFAULT_MODEL="${DEFAULT_MODEL:-/mnt/public/model/huggingface/Qwen3-30B-A3B-Instruct-2507}"                   # 默认模型名称
    export DEFAULT_SESSION_KEY="${DEFAULT_SESSION_KEY:-dataflow_demo}"     # 默认会话键
    export CODE_MODEL="${CODE_MODEL:-/mnt/public/model/huggingface/Qwen3-30B-A3B-Instruct-2507}"                       # 代码生成模型名称
    ...
    # 调试模式（用于访问/config接口）
    # -----------------------------------------------------------------------------
    export DEBUG_MODE="${DEBUG_MODE:-true}"                               # 是否启用调试模式
}
