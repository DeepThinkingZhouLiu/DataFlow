...
load_default_config() {
    ...
    export LOCAL_MODEL_NAME_OR_PATH="${LOCAL_MODEL_NAME_OR_PATH:-/mnt/public/model/huggingface/Mistral-7B-Instruct-v0.3}"  # 本地模型路径
    ...
    export DEFAULT_MODEL="${DEFAULT_MODEL:-/mnt/public/model/huggingface/Mistral-7B-Instruct-v0.3}"                   # 默认模型名称
    export DEFAULT_SESSION_KEY="${DEFAULT_SESSION_KEY:-dataflow_demo}"     # 默认会话键
    export CODE_MODEL="${CODE_MODEL:-/mnt/public/model/huggingface/Mistral-7B-Instruct-v0.3}"                       # 代码生成模型名称
