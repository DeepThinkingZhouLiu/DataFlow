...
load_default_config() {
    ...
    export DEFAULT_MODEL="${DEFAULT_MODEL:-/mnt/public/model/huggingface/Qwen2.5-7B-Instruct}"                   # 默认模型名称
    export DEFAULT_SESSION_KEY="${DEFAULT_SESSION_KEY:-dataflow_demo}"     # 默认会话键
    export CODE_MODEL="${CODE_MODEL:-/mnt/public/model/huggingface/Qwen2.5-7B-Instruct}"                       # 代码生成模型名称
